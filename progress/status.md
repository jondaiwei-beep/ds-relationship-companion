...
- SCR-01 Today Revision 2 approved; first screen gate opened to `ready_for_build`

## Next alignment work

1. Implement SCR-01 Today (gate open, Revision 2 approved).
2. Complete Invite share retry plus Web Join revoked/stale, loading, offline and authorization-loss variants.
3. Add Attention primary queue and Daily Check-in designs.
