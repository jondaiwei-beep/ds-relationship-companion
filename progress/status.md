...
1. Initialize or connect the final private repository.
2. Commit this baseline without application-code changes.
3. Export and reconcile current Notion product specifications into `product/`.
4. Generate the active screen manifest and product/design alignment table.
