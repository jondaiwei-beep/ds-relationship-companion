...
| Preserved source | `04 Core Relationship/15-agreements.webp` |

## 1. Product contract

- Requirement IDs: None — Public MVP reference
- Flow IDs: None
- Job to be done: Future lightweight shared structure, outside Core Beta.
- Entry and preconditions: Not available in Core Beta.
- Roles and permissions: Future contract required.
- Business logic and state transitions: Do not implement or expose in Core Beta navigation.
- Acceptance criteria: Remains visual evidence only until a Public MVP product contract is approved.
...
- [ ] Reference-size implementation render stored under `design/qa/implementation/SCR-15/`
