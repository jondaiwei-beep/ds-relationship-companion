...
- Flow IDs: None
- Job to be done: Future advanced reflection/memory, outside Core Beta.
- Entry and preconditions: Not available in Core Beta.
- Roles and permissions: Future privacy contract required.
- Business logic and state transitions: Do not implement; Core Beta uses simple Check-in and light D7.
