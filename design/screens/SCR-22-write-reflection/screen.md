...
| Preserved source | `07 Reflection Check-in and Consent/22-write-reflection.webp` |

## 1. Product contract

- Requirement IDs: `REQ-CHECKIN-001`, `REQ-PRIVACY-001`, `REQ-RECOVERY-001`
- Flow IDs: `FLOW-RECEIVE-001`
- Job to be done: Share or privately record simple mood, energy and need context.
- Entry and preconditions: Member opens Check-in from Today/first interaction.
- Roles and permissions: Creator owns visibility; Private does not auto-share when a partner joins.
- Business logic and state transitions: Replace essay-first advanced reflection with mood/energy/need, optional note and explicit Private/Shared choice.
- Acceptance criteria: A short check-in is completable quickly and visibility is unambiguous.
...
- replace with simple mood, energy, need Daily Check-in
- retain advanced private reflection for P1
...
- [ ] Reference-size implementation render stored under `design/qa/implementation/SCR-22/`
