...
| Preserved source | `07 Reflection Check-in and Consent/23-weekly-check-in.webp` |
...
- simplify multi-step flow to one D7 card
- actions are Keep, Adjust, Pause
...
- [ ] Reference-size implementation render stored under `design/qa/implementation/SCR-23/`
